...
G4mismatch was developed using scores reported in the G4-seq experiments (GEO accession number GSE63874). The input file to G4mismatch-PQ will be the one generated by `prepPQ.py`:
```
python prepPQ.py \
       -i <input file> \
```
